...
keywords:
  ...
  - Obstacle Detection
abstract: >
  El articulo presenta AHRUS, un sistema que utiliza ultrasonido parametrico
  para hacer audible informacion del entorno a personas con discapacidad visual
  o ceguera. Gracias a la autodemodulacion se conservan propiedades
  direccionales del ultrasonido, de modo que las senales pueden percibirse con
  los propios oidos. El trabajo describe la arquitectura tecnica de un
  prototipo y primeros escenarios de uso. En una evaluacion inicial con cuatro
  participantes, el sistema se probo en la practica. En comparacion con la
  ecolocalizacion flash sonar clasica, el enfoque muestra ventajas en
  estructuras pequenas y en el problema stealth de superficies lisas.
...
heroImage:
  ...
  alt: Foto del prototipo AHRUS con matriz de transductores ultrasónicos.
  caption: Prototipo AHRUS del paper HCII.
figures:
  - src: /research/ahrus/fig-01-overview.png
    ...
    caption: Fig. 1 Vista general de representacion direccional.
  - src: /research/ahrus/fig-02-azimuth-detail.png
    webp: /research/ahrus/fig-02-azimuth-detail.webp
    alt: Vista de detalle de acimut con movimiento lateral de la fuente sonora.
  ...
  - src: /research/ahrus/fig-05-prototype-overview.png
    ...
    caption: Fig. 3 Implementacion de prototipo.
  - src: /research/ahrus/fig-06-prototype-transducer-detail.png
    webp: /research/ahrus/fig-06-prototype-transducer-detail.webp
    alt: Foto de detalle de la matriz circular de transductores en el prototipo AHRUS.
    caption: Fig. 3 Detalle de matriz de transductores.
  ...
  - src: /research/ahrus/fig-08-distance-direction-borders.png
    ...
    alt: Grafico de barras sobre percepcion de distancia, direccion y zonas limite en cuatro participantes.
  ...
  - src: /research/ahrus/fig-10-width-estimation.png
    ...
    alt: Grafico de barras sobre desviacion en estimacion de anchura de obstaculos.
    caption: Fig. 7 Estimacion de anchura de obstaculo.
  ...
  - src: /research/ahrus/fig-12-flash-sonar-detail.png
    ...
    alt: Vista de detalle de dispersion sonora amplia de un chasquido de lengua en flash sonar.
  ...
  - src: /research/ahrus/fig-13-ahrus-directivity-detail.png
    ...
    alt: Vista de detalle de dispersion sonora focalizada en el sistema AHRUS.
...
seo:
  ...
  description: Paper AHRUS sobre ecolocalizacion humana con ultrasonido parametrico y evaluacion inicial con cuatro participantes.
  keywords:
    - AHRUS
    - HCII
    - Human Echolocation
